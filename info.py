...
BOT_TOKEN = environ.get('BOT_TOKEN', "7019574948:AAETOa0Rim5A4P-u71YHURrEcjK7f09fJUU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6107997458 6863307763').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001942379655 -1002392388500')).split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'ROLEXX_DAS') # owner username without @
...
MSG_ALRT = environ.get('MSG_ALRT', '💕ITS ME Bᴀʀᴀᴛʜ🐦‍🔥')
